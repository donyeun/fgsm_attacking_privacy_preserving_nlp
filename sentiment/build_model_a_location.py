...
tf.flags.DEFINE_string("adv_attribute", "all", "age, gender, location, or all")
...
#                cnn.location_loss,
        ...
        for _ in range(FLAGS.num_epochs * data_size / FLAGS.batch_size):
            ...
            # train_step( batch_x, batch_loc, batch_gen, batch_age, batch_rat, optimizer_g, adv_lam=lr_lamb, lr=training_learning_rate)
            train_step( batch_x, batch_loc, batch_gen, batch_age, batch_rat, optimizer_location, adv_lam=lr_lamb, lr=training_learning_rate)
